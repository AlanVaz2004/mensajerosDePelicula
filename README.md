...
Se sabe que el paquete original tiene un precio determinado en $50.Se necesita:
...
4.Hacer que la empresa de mensajería envíe un paquete. Para ello elige cualquier mensajero entre los que pueden enviarlo y si no puede lo agrega a los paquetes pendientes. (leer también punto siguiente)Conocer la facturación de la empresa, que es el total ganado por los paquetes enviados.
5.Dado un conjunto de paquetes, enviarlos a todos.
6.Encontrar el paquete pendiente más caro y enviarlo, actualizando los pendientes en caso de haberlo podido enviar.
7.Cada punto debe tener mínimo un test que demuestren su correcto funcionamiento.
8.Agregar un nuevo mensajero y un nuevo paquete y garantizar que todo siga funcionando.
